...
const HeroSection = () => {
  return (
    <section id="home" className="py-16 md:py-28 bg-gradient-to-r from-agro-light to-white">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Quality Seeds for <span className="text-agro-primary">Nigerian Farmers</span>
            </h1>
            <p className="text-lg text-gray-600 md:pr-12">
              Providing high-quality, affordable, high-yield seeds in time to farmers across Nigeria.
              We're committed to helping farmers improve their yields and livelihoods.
            </p>
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <img
                src="https://images.unsplash.com/photo-1501286353178-1ec871a4181b?auto=format&fit=crop&q=80"
